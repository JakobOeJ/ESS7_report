...
\todo{Specifically how is the linker-file written?}
...
After execution of this command, OpenOCD stays open and connected to the chip and leaves port 3333 open on the host operating system, for GDB to connect to.
...
\end{itemize}
This featureset, makes GDB especially useful for tracking down complex bugs and
