...
shown in the image below.\\
  The results printed showed us that the new sizes and subregions distribution of the partitions before and after the algorithm. The results obtained are exactly like expected from the mapping algorithm.
\begin{figure}[H]
\centering
