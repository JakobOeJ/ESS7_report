...
\begin{wrapfigure}{R}[-35pt]{0.3\textwidth}
	\vspace{-20pt}
	\centering
...
As the memory space is not abundant, there is the need of avoiding wasting or having gaps of unused 
memory. For that the memory needed by the partitions is optimized by a sorting algorithm in order to fit 
