...
\section{MPU}
The regions are a power of two, as shown in the figure \ref{fig:ce1}. The bigger a partition is, the more likely it is
to have unallocated space, since it becomes harder to effectively utilize.\\
...
As an example, five partitions with a size of 20, 65, 120, 80 and 40 bytes are shown in figure \ref{fig:ce2}.\\
...
If they were just allocated in the most suited region for each, the memory needed would be of 480 bytes,
leaving 155 bytes unused.\\
\begin{figure}[H]
\centering
