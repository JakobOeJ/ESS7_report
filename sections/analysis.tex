...
\paragraph{Channels} are logical links spanning partitions. If necessary, as channel might logically span different modules. \todo{Has modules been defined yet?}
