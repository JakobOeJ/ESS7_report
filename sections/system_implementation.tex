...
well as prescaling this frequency for the peripheral busses.


\subsubsection{Partition and Process Setup}
\label{impl:part_proc_setup}
The idle partition (explained in section \ref{sssec:build_schedule}) is set up
first using its entrypoint \texttt{idle\_main}.\\

The rest of the partitions listed in the auto-generated C file is initialized
